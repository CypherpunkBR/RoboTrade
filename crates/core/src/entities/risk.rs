...
impl RiskLimit {
  ...
  pub fn with_circuit_breaker(mut self, consecutive_losses: u32, pause_minutes: u32) -> Self {
...
mod tests {
  ...
  fn test_risk_event_limit_breach() {
    let event =
      RiskEvent::limit_breach(RiskLimitId::new(), "Max Daily Loss", dec!(1000), dec!(1200))
