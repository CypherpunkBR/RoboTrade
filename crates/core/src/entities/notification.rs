...
mod tests {
  ...
  fn test_alert_definition_cooldown() {
    let mut alert = AlertDefinition::new("Price Alert", AlertType::Price).recurring(60); // 1 minuto de cooldown
  ...
  fn test_notification_factories() {
    ...
    let risk_notif = Notification::risk_alert("Risk Limit Breached", "Daily loss limit exceeded");
