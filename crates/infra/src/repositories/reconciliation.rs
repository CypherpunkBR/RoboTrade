...
use robotrade_core::entities::{
    Discrepancy, ReconciliationSnapshot, ReconciliationSnapshotId, ReconciliationStatus,
    ReconciliationSnapshotType,
};
...
mod tests {
    ...
    async fn test_snapshot_with_discrepancy() {
        ...
        assert_eq!(discrepancy_snapshots[0].discrepancies[0].difference, dec!(10));
    }
